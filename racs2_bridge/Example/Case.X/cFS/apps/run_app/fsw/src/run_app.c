...
double check_linear_angular_velocity(double velocity){
...
void process_input(char input) {
    switch (input) {
        case 'w':
            ...
            twist_linear_x = check_linear_limit_velocity(twist_linear_x + LIN_VEL_STEP_SIZE);
            break;
        case 'x':
        ...
        case 'd':
            ...
            twist_angular_z = check_linear_angular_velocity(twist_angular_z - ANG_VEL_STEP_SIZE);
            break;
        case 'a':
