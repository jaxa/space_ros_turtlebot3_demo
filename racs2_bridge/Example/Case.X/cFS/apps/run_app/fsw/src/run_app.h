...
#define WAFFLE_MAX_LIN_VEL  0.26   /*unit: m/s */
#define WAFFLE_MAX_ANG_VEL  1.80   /*unit: rad/s */

#define LIN_VEL_STEP_SIZE  0.01    /*unit: m/s */
#define ANG_VEL_STEP_SIZE  0.1     /*unit: rad/s */
